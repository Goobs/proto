...
var themeConfig = {
    ...
    initialize: function () {
        ...
        $('head').append($('<link rel="stylesheet">').attr('href', 'static/js/theme-config.css'));
        $this.build();
        $this.events();
    ...
    setColor: function (color) {
        ...
        $colorConfigLink.attr('href', 'static/css/theme-' + color + '.css');
        $.cookie('color', color);
    },
    setBackground: function (background) {
        ...
        if (background == 'dark') {
            $('.partners-carousel img').each(function () {
                ...
                $(this).attr('src', 'static/img/partner/' + background + '/' + arr[arr.length - 1]);
            });
        } else {
            $('.partners-carousel img').each(function () {
                var arr = $(this).attr('src').split('/');
                $(this).attr('src', 'static/img/partner/light/' + arr[arr.length - 1]);
            });
        }
    },
